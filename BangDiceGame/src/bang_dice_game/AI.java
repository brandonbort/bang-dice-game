...
// left from him the array will be as follows with 5 players. x=null
// karma_points:    x, 0,-1, 0, 0
//                  0, x, 0, 0, 0
//                  0, 0, x, 0, 0
//                  0, 0, 0, x, 0
//                  0, 0, 0, 0, x
...
// outlaws are dead.
// karma_points:    x, 0, 0, 0, 0   <Sheriff
//               -100, x, 0, 0, 0   <Outlaw1
//                100, 0, x, 0, 0   <Renegade
//               -100, 0, 0, x, 0   <Outlaw2
//                100, 0, 0, 0, x   <Deputy
...
// sheriff.
// karma_points:    x,-1, 0, 0, 1   <Sheriff
//               -100, x,-1,-1, 0   <Outlaw1
//                100, 0, x, 0, 0   <Renegade
//               -100, 0, 0, x, 0   <Outlaw2
//                 99, 0, 0, 0, x   <Deputy
...
public class AI {
    public void SheriffTurn (int karma[][]) {
        //shoot1
        int r=0;//Sheriff position always
        int target=karma[r][1];
